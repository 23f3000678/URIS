...
export const ROLE_PERMISSIONS: Record<string, Permissions> = {
  'core_admin': {
    ...
    canAssign: 'YES',
    canReview: 'YES',
    modules: ['/dashboard', '/tasks', '/review', '/team', '/alerts', '/admin', '/intelligence', '/governance', '/audit-logs']
  },
  'operations_lead': {
    ...
    canAssign: 'YES',
    canReview: 'NO',
    modules: ['/dashboard', '/tasks', '/team', '/alerts', '/intelligence']
  },
  'technical_lead': {
    ...
    canAssign: 'YES',
    canReview: 'YES',
    modules: ['/dashboard', '/tasks', '/review', '/team', '/alerts', '/intelligence']
  },
  'research_lead': {
    canSeeAllTasks: 'OWN_TEAM',
    canSeeDetailedTask: 'YES',
  ...
  'technical_intern': {
    ...
    canAssign: 'NO',
    canReview: 'NO',
    modules: ['/dashboard', '/availability', '/tasks', '/notifications', '/portfolio-edit']
  },
  'operations_intern': {
    canSeeAllTasks: 'NO',
    canSeeDetailedTask: 'OWN_TASKS',
